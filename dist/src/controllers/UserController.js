...
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, User_1.default.find({ active: true })];
                    case 1:
                        users = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            return [2 /*return*/, res.status(404).json({ message: "User not found! Please, verify the given _id" })];
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        _id = req.params._id;
                        return [4 /*yield*/, User_1.default.updateOne({ _id: _id }, req.body)];
                    case 1:
                        user = _a.sent();
                        if (user.nModified === 0) {
                            return [2 /*return*/, res.status(404).json({ message: "User not found! Please, verify the given _id" })];
    ...
    UserController.prototype.inactivate = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        _id = req.params._id;
                        return [4 /*yield*/, User_1.default.updateOne({ _id: _id }, { active: false })];
                    case 1:
                        user = _a.sent();
                        if (user.nModified === 0) {
                            return [2 /*return*/, res.status(404).json({ message: "User not found! Please, verify the given _id" })];
                        }
                        return [2 /*return*/, res.status(200).json({ message: "User inactivated successfully!" })];
                    case 2:
                        error_5 = _a.sent();
